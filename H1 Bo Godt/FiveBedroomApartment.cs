...
{
    internal class FiveBedroomApartment : FourBedroomApartment
    {
        public FiveBedroomApartment(Floor floor, Door frontDoor, Door backDoor) : base(floor, frontDoor, backDoor)
        {
            ...
            // This bedroom is the only bedroom that appears to add 25m2 to the total apartment size.
            roomsTemp[roomsTemp.Length - 1] = new Bedroom(25, bedroomWindow, bedroomDoor);
