...
{
    internal class TwoBedroomApartment : OneBedroomApartment
    {
        public TwoBedroomApartment(Floor floor, Door frontDoor, Door backDoor) : base(floor, frontDoor, backDoor)
        {
